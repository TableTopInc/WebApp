...
// 		}
// 	});
// 	var facebookAuthURL = `https://www.facebook.com/v5.0/dialog/oauth?client_id=${options.client_id}&redirect_uri=${options.redirect_uri}&response_type=token,granted_scopes&scope=${options.scopes}&display=popup`;
